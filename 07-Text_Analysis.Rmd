...
Sys.setenv(NEWS_API_KEY = "89610f37b61a43c389d3830aebff2a81")   
...
Let's now turn to topic proportions per document  (γ matrix)
...
```
```r
## Average prominence of each topic across the corpus
doc_topics %>%
  group_by(topic) %>%
